				...
				<div className="about-section py-20">
					<div className="container mx-auto px-4 text-center">
						...
						<p className="mb-10 text-xl">
							...
							profiles, it aims to create a better experience for both adopters
							and owners.
						</p>
						<p className="mb-10 text-xl">
							Our mission is to promote responsible pet ownership and reduce pet
							overpopulation in shelters. By leveraging technology and
